...
mod rustaceans_error_cases {
    ...
    #[test]
    fn test_viewer_cannot_get_rustaceans_unauthorized() {
        let client = Client::new();
        let client_admin = common::get_client_with_logged_in_admin();

        let rustacean1: Value = common::create_test_rustacean(&client_admin);
        let rustacean2: Value = common::create_test_rustacean(&client_admin);
        ...
        common::delete_test_rustacean(&client_admin, rustacean1);
        common::delete_test_rustacean(&client_admin, rustacean2);
    }

    #[test]
    fn test_create_rustacean_error() {
        let client = Client::new();
    ...
    #[test]
    fn test_view_rustacean_unauthorized() {
        let client = Client::new();
        let client_editor = common::get_client_with_logged_in_editor();
        let rustacean: Value = common::create_test_rustacean(&client_editor);
    ...
    #[test]
    fn test_update_rustacean_error() {
        let client = Client::new();
        let client_editor = common::get_client_with_logged_in_editor();
        let rustacean: Value = common::create_test_rustacean(&client_editor);
    ...
    #[test]
    fn test_delete_rustacean_error() {
        let client = Client::new();
        let client_editor = common::get_client_with_logged_in_editor();
        let rustacean: Value = common::create_test_rustacean(&client_editor);
